...
| `Klassen.dc.html` | Klassenwahl — historischer Draft / deprecated (nicht produktrelevant) |
...
- Klassen-Sigel sind **deprecated / nicht produktrelevant** (CONCEPT.md §5: keine Klassen; Leitung 2026-09-14). Nicht in Produkt-UI verdrahten; Abschnitt im Designsystem nur noch historisch.
